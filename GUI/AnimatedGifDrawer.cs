...
{
	public string loadingGifPath = "Assets\\Resources\\Textures\\start.gif";
	...
	void OnGUI()
	{
		GUI.DrawTexture(new Rect(drawPosition.x, drawPosition.y, Screen.width, Screen.height), gifFrames[(int)(Time.frameCount * speed) % gifFrames.Count]);
	}
}